...
render:function()
{
  ...
  aggregatedArray.list.forEach(function(weather_data){
       ...
       console.log("data2");
       console.log(temp);
       arr.push(<WeatherGrandChild dt_txt={dt_txt}  windspeed={windspeed} temp={temp} temp_min={temp_min} description={description} temp_max={temp_max} pressure={pressure} humidity={humidity}/>);
  });
